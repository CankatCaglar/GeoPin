...
class WorldCuisineButtonGameScreen extends ConsumerStatefulWidget {
  const WorldCuisineButtonGameScreen({super.key});

  @override
  ConsumerState<WorldCuisineButtonGameScreen> createState() => _WorldCuisineButtonGameScreenState();
}

class _WorldCuisineButtonGameScreenState extends ConsumerState<WorldCuisineButtonGameScreen> {
  final MapController _mapController = MapController();

  int _currentIndex = 0;
  final Set<String> _answeredIds = {}; // Doğru bilinen yemek lokasyonları
  String? _selectedId;

  @override
  Widget build(BuildContext context) {
    final allQuestions = ref.watch(questionsProvider);
    final allCuisineQuestions =
        allQuestions.where((q) => q.categoryId == 'world_cuisine').toList();
    final totalQuestions = allCuisineQuestions.length;

    // Tüm lokasyonlar doğru cevaplandı mı?
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppLocalizations().get('cuisine_completed'),
                      ...
                      Padding(
                        ...
                        child: Text(
                          AppLocalizations().get('cuisine_completed_msg'),
                          style: const TextStyle(
                            fontSize: 16,
    ...
    final currentQuestion = allCuisineQuestions[_currentIndex];
    ...
    final visibleQuestions =
        allCuisineQuestions.where((q) => !_answeredIds.contains(q.id)).toList();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppLocalizations().get('world_cuisine')),
        centerTitle: true,
      ),
      body: Stack(
        children: [
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  padding: const EdgeInsets.symmetric(vertical: 14),
                  backgroundColor:
                      _selectedId == null ? Colors.blueAccent : Colors.orangeAccent,
                  foregroundColor: Colors.white,
                  shape: RoundedRectangleBorder(
