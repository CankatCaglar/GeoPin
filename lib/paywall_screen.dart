                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 16),
                                _buildFeatureRow(loc.currentLanguage == 'tr' ? 'Formula 1 Pistleri' : 'Formula 1 Circuits'),
                                const SizedBox(height: 16),
                                _buildFeatureRow(loc.currentLanguage == 'tr' ? 'Dünyaca Ünlü Markalar' : 'World Famous Brands'),
                                const SizedBox(height: 16),
                                _buildFeatureRow(loc.currentLanguage == 'tr' ? 'Ünlü İnsanlar ve Karakterler' : 'Famous People & Characters'),
                              ],
                            ),
                          ),
                        ),
